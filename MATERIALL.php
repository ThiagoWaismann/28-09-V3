            ...
            <?php
                    ...
                    <div class="row vh-150 bg-secondary rounded align-items-center justify-content-center mx-0">
                        <div class="col-md-10 text-center">
                            <div class="container-fluid pt-6 px-10">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="container-fluid pt-5 px-8">
                                        
                                        <h3>GUARDAR MATERIAIS</h3>
                                        <br>
                                        <a href="guardar.php" class="">
                                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">ENTRADA DE MATERIAL</button>
                                        </a>

                                        <a href="TNSFLML.php" class="">
                                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">TRANSFERIR MATERIAL PARA OUTRA LOCALIZAÇÃO DENTRO DO IA08</button>
                                        </a>
