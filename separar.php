        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="inicial.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"></i>KANBAN IA08</h3>
                </a>
            ...
            <div class="container-fluid pt-4 px-5">
                <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-5 text-center">
                        <h3>SEPARAR MATERIAIS PARA ORDEM</h3>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            
                           
                            <div class="container-fluid pt-4 px-5">
                                <input type="email" class="form-control" id="floatingInput" placeholder="INSIRA O CODIGO DA ORDEM">
