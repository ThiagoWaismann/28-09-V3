                ...
                <div class="row vh-200 bg-custom rounded align-items-center justify-content-center mx-0">
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-md-7 text-center  ">
                            ...
                            <a href="CILOL.php" class="">
                                <button type="submit" class="btn btn-primary py-3 w-100 mb-4">LIBERAÇÃO DE ORDENS</button>
                            </a>
                            <a href="QNL.php" class="">
                                <button type="submit" class="btn btn-primary py-3 w-100 mb-4">QUADRO DE NIVELAMENTO</button>
                            </a>
                            <hr style="border: 6px solid white;">
                            <a href="LOGOUTCI.php" class="">
