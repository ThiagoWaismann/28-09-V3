...
function cadastrarMateriais() {
    ...
    if ($_SESSION['nivel'] >= 8) {
        ...
        if ($resultExistencia !== false && $resultExistencia['EXISTE'] > 0) {
            ...
            $queryTipo1 = "SELECT TIPO FROM DATA1 WHERE MATERIAL = '$material'";
            $resultTipo1 = $db->exec($queryTipo1);
            ...
            $mat1 = "SELECT MATERIAL FROM DATA1 WHERE MATERIAL = '$material'";
            $resultmat1 = $db->exec($mat1);
