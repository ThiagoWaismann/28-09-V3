                ...
                <div class="row vh-200 bg-secondary rounded align-items-center justify-content-center mx-0">
                    ...
                    <div class="col-md-7 text-center">
                            ...
                            <div class="container-fluid pt-2 px-2">
                                ...
                                <h3>CORREÇÃO DE SALDO PARA SUBTRAÇÃO</h3></a>
                                    <form action="CSPB.php" method="post" onsubmit="return validateForm();"></a>
                                            MATERIAL: <input type="text" class="form-control" name="material" id="materialInput" placeholder="INSIRA O MATERIAL" required><br>
                                            
                                            LOCAL: <input type="text" class="form-control" name="local" id="localInput" placeholder="INSIRA A LOCALIZAÇÃO" required>
                                            
                                            <span id="localError" style="color: red;"></span><br>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-3"><br>
                                                <button type="submit" class="btn btn-primary py-3 w-100 mb-8">CORRIGIR</button><br>
                                            </div><br>
                                    </form>
                                </div>
                            </div>
                    ...
                    function validateForm() {
                        ...
                        var localPattern = /^\d{2}\.\d{2}\.\d{2}$/;
                        if (!localPattern.test(localInput)) {
                            localError.textContent = "Formato inválido para o LOCAL, insira no seguinte formato (00.00.00)";
                            return false; 
                        } else {
