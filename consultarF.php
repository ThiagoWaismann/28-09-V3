                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="container-fluid pt-4 px-5">
                             ...
                             <form action="consultar.php" method="post">
                                ...
                                MATERIAL: <input type="text" name="material" class="form-control" id="floatingInput" placeholder="Digite o material">
                              
                                <label for="floatingInput"></label>
                                <button type="submit" class="btn btn-primary py-3 w-100 mb-4">CONSULTAR</button>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                <!--input button type="submit" class="btn btn-primary py-3 w-100 mb-4" value="CONSULTAR"></button-->
