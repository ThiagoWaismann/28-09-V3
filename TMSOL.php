            ...
            <div class="container-fluid pt-2 px-2">
                <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
                    ...
                    echo $nomeUsuario;
                         ...
                         ?>
                        <h3>TRANSFERIR MATERIAL SEM ORDEM</h3>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                           
                            <div class="container-fluid pt-6 px-6">
                                
                                
                                <form action="TMSOP.php" method="post">
                                        ...
                                        CENTRO:
                                    <select name="tabela_destino" class="form-select" id="tabela" required>
                                            <option value=""></option>
                                        ...
                                        MOTIVO: <input type="text" class="form-control" name="motivo" id="floatingInput" placeholder="MOTIVO DA TRANSFERENCIA" required>
