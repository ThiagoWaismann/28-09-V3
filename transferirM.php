                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                ...
                                <a href="inicial.php" class="dropdown-item active">MENU INICIAL</a>
                                <a href="signin.php" class="dropdown-item active">LOGIN</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="container-fluid pt-4 px-5">
                                ...
                                <form action="transfer.php" method="post">
                                        ...
                                        CENTRO DE TRABALHO: <input type="text" class="form-control" name="tabela_destino" id="floatingInput" placeholder="DESTINO" required>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">TRANSFERIR</button>
                                </form>    
