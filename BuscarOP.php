        ...
        <div class="container-fluid pt-2 px-2">
                ...
                <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
                    ...
                    <div class="col-md-5 text-center">
                        <h3>INICIAR SEPARAÇÃO DE ORDEM</h3>
                        
                        <div class="d-flex align-items-center justify-content-between mb-3">
                           
                            <div class="container-fluid pt-4 px-5">
                                ORDEM: <input type="text" name="ordem" class="form-control" id="floatingInput" placeholder="INSIRA A ORDEM" required>
                                <label for="floatingInput"></label>
                                LINHA: <input type="text" name="centro" class="form-control" id="centro" placeholder="INSIRA A LINHA" required>
            ...
            <!--div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                    <a href="inicial.php" class="echo">
                         <button type="href" class="btn btn-primary py-3 w-100 mb-4">RETORNAR AO MENU INICIAL</button>
                    </a> 
