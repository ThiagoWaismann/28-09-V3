...
<body>
                ...
                <div class="row vh-200 bg-secondary rounded align-items-center justify-content-center mx-0">
                    ...
                    <div class="col-md-7 text-center">
                            ...
                            <div class="container-fluid pt-2 px-2">
                                ...
                                <h3>BAIXA DE ORDEM DE PRODUÇÃO</h3></a>
                                    <form action="BOSAPP.php" method="post" onsubmit="return validateForm();"></a>
                                            ORDEM: <input type="text" class="form-control" name="material" id="materialInput" placeholder="INSIRA A ORDEM" required><br>
                                            <span id="materialError" style="color: red;"></span><br>
                                            LINHA: <input type="text" class="form-control" name="linha" id="linhaInput" placeholder="INSIRA A LINHA" required oninput="validarEntrada(this)"><br>
                                            QUANTIDADE: <input type="number" class="form-control" name="quantidade" id="quantidadeInput" placeholder="INSIRA A QUANTIDADE" required min="0" max="999"><br>
                                            <label for="floatingInput"></label>
                                            <div class="d-flex align-items-center justify-content-between mb-3"><br>
                                                <button type="submit" id="executarBtn" class="btn btn-primary py-3 w-100 mb-8">EXECUTAR</button><br>
                                            </div><br>
                                    </form>
                                </div>
                            </div>
    ...
    document.querySelector("form").addEventListener("submit", disableButton);
</script>
